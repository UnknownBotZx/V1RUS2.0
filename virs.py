...
#
# VIRUS is one of the Most Powerful iDDOS Tool
# This tool can Shut down any websites
# 
#
# author : UnknownBot , version 2.0
...
def usage():
	print 'VIRUS THE BEST iDDoS Tool'
	print 'CyberPirateBD Facebook: http://m.facebook.com/cyberpiratebd'
	print 'Loaded Botnets: 1,798,445,657'
	print 'Usage: virs (url)'
	print 'Example:  virs.py http://israbank.gov.il/'
	print "\a"
print \
"""
&&.......&&...&&&&.....&&&&&.....&&....&&...&&&&&
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "VIRUS The Deadlist iDDoS Tool "
